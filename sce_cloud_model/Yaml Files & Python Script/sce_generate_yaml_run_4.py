...
consumption_fraction_dict = {'Bin1': 0.1, 'Bin2': 0.1, 'Bin3': 0.2, 'Bin4': 0.2, 'Bin5': 0.4}
...
def generate_sce_data_yaml():
    f = open('Scenario_4.yaml','wb')
    f.write('# Scenario 4: High Consumption due to PEV\n')
    ...
    f.write('#    1. Percentage of customers in each consumption category: [10, 10, 10, 20, 40]\n')
