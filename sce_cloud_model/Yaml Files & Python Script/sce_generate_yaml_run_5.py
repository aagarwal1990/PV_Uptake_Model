...
consumption_fraction_dict = {'Bin1': 0.3, 'Bin2': 0.25, 'Bin3': 0.25, 'Bin4': 0.1, 'Bin5': 0.1}
...
def generate_sce_data_yaml():
    f = open('Scenario_5.yaml','wb')
    f.write('# Scenario 5: Significantly Higher proportion of Low Consumption people \n')
    ...
    f.write('#    1. Percentage of customers in each consumption category: [30, 25, 25, 10, 10]\n')
